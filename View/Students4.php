...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Lista de Estudiantes de Quinto Grado</h1>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                            ...
                            <tbody>
                                <?php foreach ($students as $student): ?>
                                    <tr>
                                        ...
                                        <td><a href="../View/viewStudent4.php?id=<?php echo $student['id_student']; ?>" class="btn btn-primary"><i class="fas fa-eye"></i></a></td>
                                        <?php if ($_SESSION['role_id'] != 2): ?>
                                            <td><a href="../View/editStudent4.php?id=<?php echo $student['id_student']; ?>" class="btn btn-success"><i class="fas fa-pen"></i></a></td>
                                            <td>
                    ...
                    <?php else: ?>
                        <p>No hay estudiantes de quinto grado registrados.</p>
                    <?php endif; ?>
                </div>
            </div>
            <?php if ($teacher): ?>
