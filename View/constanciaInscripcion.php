...
if (isset($_POST['id_card'])) {
    ...
    <body>
    <img  src='$imagePath1' alt='Logo' width='100' height='100'><img src='$imagePath' style='margin-left:70%;'alt='Logo' width='90' height='100'>
            ...
            <p class='justificado'>La suscrita Directora  (e) de la <strong>Escuela Básica Nacional “PADRE JESUS NIETO” Licda, Mayra Romero Cedula de Identidad: 13.017.996,</strong> hace constar por medio de la presente  que el <strong>Alumno: </strong><strong style='text-transform: uppercase'> $name1 $last_name1,</strong>
             Cedula de <strong>Identidad/Escolar: $id_card,</strong> natural de: <strong style='text-transform: uppercase'>$birthplace, Edo. $state,</strong> y de <strong>$year1</strong> de Edad, está inscrito en este plantel cursando: <strong style='text-transform: uppercase'>  $description </strong>Educación Básica en el año escolar: <strong>2023-2024.</strong></p>
             <br>
...
0412-8584797
    ...
    $dompdf->stream("Constacia de Instricion.pdf", array("Attachment" => false));
} else {
