                ...
                <div class="row justify-content-center">
                            <div class="col-lg-7">
                                ...
                                <center><img src="../assets/img/logo.png" width="20%" alt=""></center> 
                                    ...
                                    <div class="card-body">
                                    <form id="multiStepForm" action="../php/UpdateStudent5.php" method="POST">
                                ...
                                <h3>Paso 5</h3>
                                     <div class="row mb-3">
                                        ...
                                        <?php foreach ($responsibles as $responsible): ?>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-floating">
                                                    <input class="form-control" required  id="numero" type="text"   name="year_responsible" minlength="2" maxlength="3" value="<?php echo $responsible['year_responsible']; ?>" oninput="soloNumeros(event)"   placeholder="Enter your last name" />
                                                        <label for="inputLastName">Edad</label>
                                                    </div>
                                                </div>
                                            </div>
