                ...
                <div class="row justify-content-center">
                            <div class="col-lg-7">
                                ...
                                <center><img src="../assets/img/logo.png" width="20%" alt=""></center> 
                                    ...
                                    <div class="card-body">
                                    <form id="multiStepForm" action="../php/UpdateStudent3.php" method="POST">
                                ...
                                <h3>Paso 5</h3>
                                     <div class="row mb-3">
                                        ...
                                        <?php foreach ($responsibles as $responsible): ?>
                                                    ...
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="letras" type="text" required name="responsible" value="<?php echo $responsible['responsible']; ?>"  oninput="soloLetras(event)" placeholder="Enter your first name" />
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-floating">
                                                    <input class="form-control" id="numero" type="text"  required name="year_responsible" minlength="2" maxlength="3" value="<?php echo $responsible['year_responsible']; ?>" oninput="soloNumeros(event)"   placeholder="Enter your last name" />
                                                        <label for="inputLastName">Edad</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-floating mb-3">
                                            <input class="form-control"  type="text" name="address_responsible" required value="<?php echo $responsible['address_responsible']; ?>"  placeholder="Enter your first name" />
                                                        <label for="inputFirstName">Dirección</label>
                                            </div>
            <div class="mb-3">
            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control"  id="letras" type="text" required name="profession_responsible" value="<?php echo $responsible['profession_responsible']; ?>" oninput="soloLetras(event)"  placeholder="name@example.com" />
