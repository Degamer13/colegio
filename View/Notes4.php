...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Lista de Notas de Quinto Grado</h1>
                ...
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($nota['description2']); ?></td>
                                    ...
                                    <?php if ($_SESSION['role_id'] != 2): ?>
                                         ...
                                         <td><a href="../View/editNote4.php?id=<?php echo $nota['id_report']; ?>" class="btn btn-success"><i class="fas fa-pen"></i></a></td>
